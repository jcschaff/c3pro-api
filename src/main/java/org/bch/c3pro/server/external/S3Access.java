...
public class S3Access implements KeyValueStorage {
    ...
    public void put(String key, String value) throws C3PROException {
        ...
        String s3BucketName = AppConfig.getProp(AppConfig.AWS_S3_BUCKET_NAME, AppConfig.AWS_S3_BUCKET_NAME_DEFAULT);
		s3.putObject(new PutObjectRequest(s3BucketName, key, in, om));
    }
    ...
    private void setCredentials() throws C3PROException {
        if (this.s3 == null) {
            ...
            try {
                String s3Profile = AppConfig.getProp(AppConfig.AWS_S3_PROFILE, AppConfig.AWS_S3_PROFILE_DEFAULT);
                System.setProperty("aws.profile", s3Profile);
            ...
            String regionName = AppConfig.getProp(AppConfig.AWS_S3_REGION, AppConfig.AWS_S3_REGION_DEFAULT);
